...
const DeviceVectors exception_table = {
        ...
        .pfnOSCCTRL_XOSC0_Handler   = (void*) OSCCTRL_0_Handler,      /*  2 OSCCTRL_XOSCFAIL_0, OSCCTRL_XOSCRDY_0 */
        .pfnOSCCTRL_XOSC1_Handler   = (void*) OSCCTRL_1_Handler,      /*  3 OSCCTRL_XOSCFAIL_1, OSCCTRL_XOSCRDY_1 */
        .pfnOSCCTRL_DFLL_Handler   = (void*) OSCCTRL_2_Handler,      /*  4 OSCCTRL_DFLLLOCKC, OSCCTRL_DFLLLOCKF, OSCCTRL_DFLLOOB, OSCCTRL_DFLLRCS, OSCCTRL_DFLLRDY */
        .pfnOSCCTRL_DPLL0_Handler   = (void*) OSCCTRL_3_Handler,      /*  5 OSCCTRL_DPLLLCKF_0, OSCCTRL_DPLLLCKR_0, OSCCTRL_DPLLLDRTO_0, OSCCTRL_DPLLLTO_0 */
        .pfnOSCCTRL_DPLL1_Handler   = (void*) OSCCTRL_4_Handler,      /*  6 OSCCTRL_DPLLLCKF_1, OSCCTRL_DPLLLCKR_1, OSCCTRL_DPLLLDRTO_1, OSCCTRL_DPLLLTO_1 */
        .pfnOSC32KCTRL_Handler  = (void*) OSC32KCTRL_Handler,     /*  7 32kHz Oscillators Control */
        .pfnSUPC_OTHER_Handler      = (void*) SUPC_0_Handler,         /*  8 SUPC_B12SRDY, SUPC_B33SRDY, SUPC_BOD12RDY, SUPC_BOD33RDY, SUPC_VCORERDY, SUPC_VREGRDY */
        .pfnSUPC_BODDET_Handler      = (void*) SUPC_1_Handler,         /*  9 SUPC_BOD12DET, SUPC_BOD33DET */
        .pfnWDT_Handler         = (void*) WDT_Handler,            /* 10 Watchdog Timer */
        .pfnRTC_Handler         = (void*) RTC_Handler,            /* 11 Real-Time Counter */
        .pfnEIC_EXTINT_0_Handler       = (void*) EIC_0_Handler,          /* 12 EIC_EXTINT_0 */
        .pfnEIC_EXTINT_1_Handler       = (void*) EIC_1_Handler,          /* 13 EIC_EXTINT_1 */
        .pfnEIC_EXTINT_2_Handler       = (void*) EIC_2_Handler,          /* 14 EIC_EXTINT_2 */
        .pfnEIC_EXTINT_3_Handler       = (void*) EIC_3_Handler,          /* 15 EIC_EXTINT_3 */
        .pfnEIC_EXTINT_4_Handler       = (void*) EIC_4_Handler,          /* 16 EIC_EXTINT_4 */
        .pfnEIC_EXTINT_5_Handler       = (void*) EIC_5_Handler,          /* 17 EIC_EXTINT_5 */
        .pfnEIC_EXTINT_6_Handler       = (void*) EIC_6_Handler,          /* 18 EIC_EXTINT_6 */
        .pfnEIC_EXTINT_7_Handler       = (void*) EIC_7_Handler,          /* 19 EIC_EXTINT_7 */
        .pfnEIC_EXTINT_8_Handler       = (void*) EIC_8_Handler,          /* 20 EIC_EXTINT_8 */
        .pfnEIC_EXTINT_9_Handler       = (void*) EIC_9_Handler,          /* 21 EIC_EXTINT_9 */
        .pfnEIC_EXTINT_10_Handler      = (void*) EIC_10_Handler,         /* 22 EIC_EXTINT_10 */
        .pfnEIC_EXTINT_11_Handler      = (void*) EIC_11_Handler,         /* 23 EIC_EXTINT_11 */
        .pfnEIC_EXTINT_12_Handler      = (void*) EIC_12_Handler,         /* 24 EIC_EXTINT_12 */
        .pfnEIC_EXTINT_13_Handler      = (void*) EIC_13_Handler,         /* 25 EIC_EXTINT_13 */
        .pfnEIC_EXTINT_14_Handler      = (void*) EIC_14_Handler,         /* 26 EIC_EXTINT_14 */
        .pfnEIC_EXTINT_15_Handler      = (void*) EIC_15_Handler,         /* 27 EIC_EXTINT_15 */
        ...
        .pfnEVSYS_OTHER_Handler     = (void*) EVSYS_4_Handler,        /* 40 EVSYS_EVD_10, EVSYS_EVD_11, EVSYS_EVD_4, EVSYS_EVD_5, EVSYS_EVD_6, EVSYS_EVD_7, EVSYS_EVD_8, EVSYS_EVD_9, EVSYS_OVR_10, EVSYS_OVR_11, EVSYS_OVR_4, EVSYS_OVR_5, EVSYS_OVR_6, EVSYS_OVR_7, EVSYS_OVR_8, EVSYS_OVR_9 */
        ...
        .pfnSERCOM0_OTHER_Handler   = (void*) SERCOM0_3_Handler,      /* 49 SERCOM0_3, SERCOM0_4, SERCOM0_5, SERCOM0_6 */
        ...
        .pfnSERCOM1_OTHER_Handler   = (void*) SERCOM1_3_Handler,      /* 53 SERCOM1_3, SERCOM1_4, SERCOM1_5, SERCOM1_6 */
        ...
        .pfnSERCOM2_OTHER_Handler   = (void*) SERCOM2_3_Handler,      /* 57 SERCOM2_3, SERCOM2_4, SERCOM2_5, SERCOM2_6 */
        ...
        .pfnSERCOM3_OTHER_Handler   = (void*) SERCOM3_3_Handler,      /* 61 SERCOM3_3, SERCOM3_4, SERCOM3_5, SERCOM3_6 */
#ifdef ID_SERCOM4
        ...
        .pfnSERCOM4_2_Handler   = (void*) SERCOM4_3_Handler,      /* 65 SERCOM4_3, SERCOM4_4, SERCOM4_5, SERCOM4_6 */
#else
        ...
        .pfnSERCOM5_OTHER_Handler   = (void*) SERCOM5_3_Handler,      /* 69 SERCOM5_3, SERCOM5_4, SERCOM5_5, SERCOM5_6 */
#else
        ...
        .pfnSERCOM6_OTHER_Handler   = (void*) SERCOM6_3_Handler,      /* 73 SERCOM6_3, SERCOM6_4, SERCOM6_5, SERCOM6_6 */
#else
        ...
        .pfnSERCOM7_OTHER_Handler   = (void*) SERCOM7_3_Handler,      /* 77 SERCOM7_3, SERCOM7_4, SERCOM7_5, SERCOM7_6 */
#else
...
#endif
#ifdef ID_USB
        .pfnUSB_OTHER_Handler       = (void*) USB_0_Handler,          /* 80 USB_EORSM_DNRSM, USB_EORST_RST, USB_LPMSUSP_DDISC, USB_LPM_DCONN, USB_MSOF, USB_RAMACER, USB_RXSTP_TXSTP_0, USB_RXSTP_TXSTP_1, USB_RXSTP_TXSTP_2, USB_RXSTP_TXSTP_3, USB_RXSTP_TXSTP_4, USB_RXSTP_TXSTP_5, USB_RXSTP_TXSTP_6, USB_RXSTP_TXSTP_7, USB_STALL0_STALL_0, USB_STALL0_STALL_1, USB_STALL0_STALL_2, USB_STALL0_STALL_3, USB_STALL0_STALL_4, USB_STALL0_STALL_5, USB_STALL0_STALL_6, USB_STALL0_STALL_7, USB_STALL1_0, USB_STALL1_1, USB_STALL1_2, USB_STALL1_3, USB_STALL1_4, USB_STALL1_5, USB_STALL1_6, USB_STALL1_7, USB_SUSPEND, USB_TRFAIL0_TRFAIL_0, USB_TRFAIL0_TRFAIL_1, USB_TRFAIL0_TRFAIL_2, USB_TRFAIL0_TRFAIL_3, USB_TRFAIL0_TRFAIL_4, USB_TRFAIL0_TRFAIL_5, USB_TRFAIL0_TRFAIL_6, USB_TRFAIL0_TRFAIL_7, USB_TRFAIL1_PERR_0, USB_TRFAIL1_PERR_1, USB_TRFAIL1_PERR_2, USB_TRFAIL1_PERR_3, USB_TRFAIL1_PERR_4, USB_TRFAIL1_PERR_5, USB_TRFAIL1_PERR_6, USB_TRFAIL1_PERR_7, USB_UPRSM, USB_WAKEUP */
        .pfnUSB_SOF_HSOF_Handler       = (void*) USB_1_Handler,          /* 81 USB_SOF_HSOF */
        .pfnUSB_TRCPT0_Handler       = (void*) USB_2_Handler,          /* 82 USB_TRCPT0_0, USB_TRCPT0_1, USB_TRCPT0_2, USB_TRCPT0_3, USB_TRCPT0_4, USB_TRCPT0_5, USB_TRCPT0_6, USB_TRCPT0_7 */
        .pfnUSB_TRCPT1_Handler       = (void*) USB_3_Handler,          /* 83 USB_TRCPT1_0, USB_TRCPT1_1, USB_TRCPT1_2, USB_TRCPT1_3, USB_TRCPT1_4, USB_TRCPT1_5, USB_TRCPT1_6, USB_TRCPT1_7 */
#else
...
#endif
        .pfnTCC0_OTHER_Handler      = (void*) TCC0_0_Handler,         /* 85 TCC0_CNT_A, TCC0_DFS_A, TCC0_ERR_A, TCC0_FAULT0_A, TCC0_FAULT1_A, TCC0_FAULTA_A, TCC0_FAULTB_A, TCC0_OVF, TCC0_TRG, TCC0_UFS_A */
        .pfnTCC0_MC0_Handler      = (void*) TCC0_1_Handler,         /* 86 TCC0_MC_0 */
        .pfnTCC0_MC1_Handler      = (void*) TCC0_2_Handler,         /* 87 TCC0_MC_1 */
        .pfnTCC0_MC2_Handler      = (void*) TCC0_3_Handler,         /* 88 TCC0_MC_2 */
        .pfnTCC0_MC3_Handler      = (void*) TCC0_4_Handler,         /* 89 TCC0_MC_3 */
        .pfnTCC0_MC4_Handler      = (void*) TCC0_5_Handler,         /* 90 TCC0_MC_4 */
        .pfnTCC0_MC5_Handler      = (void*) TCC0_6_Handler,         /* 91 TCC0_MC_5 */
        .pfnTCC1_OTHER_Handler      = (void*) TCC1_0_Handler,         /* 92 TCC1_CNT_A, TCC1_DFS_A, TCC1_ERR_A, TCC1_FAULT0_A, TCC1_FAULT1_A, TCC1_FAULTA_A, TCC1_FAULTB_A, TCC1_OVF, TCC1_TRG, TCC1_UFS_A */
        .pfnTCC1_MC0_Handler      = (void*) TCC1_1_Handler,         /* 93 TCC1_MC_0 */
        .pfnTCC1_MC1_Handler      = (void*) TCC1_2_Handler,         /* 94 TCC1_MC_1 */
        .pfnTCC1_MC2_Handler      = (void*) TCC1_3_Handler,         /* 95 TCC1_MC_2 */
        .pfnTCC1_MC3_Handler      = (void*) TCC1_4_Handler,         /* 96 TCC1_MC_3 */
        .pfnTCC2_OTHER_Handler      = (void*) TCC2_0_Handler,         /* 97 TCC2_CNT_A, TCC2_DFS_A, TCC2_ERR_A, TCC2_FAULT0_A, TCC2_FAULT1_A, TCC2_FAULTA_A, TCC2_FAULTB_A, TCC2_OVF, TCC2_TRG, TCC2_UFS_A */
        .pfnTCC2_MC0_Handler      = (void*) TCC2_1_Handler,         /* 98 TCC2_MC_0 */
        .pfnTCC2_MC1_Handler      = (void*) TCC2_2_Handler,         /* 99 TCC2_MC_1 */
        .pfnTCC2_MC2_Handler      = (void*) TCC2_3_Handler,         /* 100 TCC2_MC_2 */
#ifdef ID_TCC3
        .pfnTCC3_OTHER_Handler      = (void*) TCC3_0_Handler,         /* 101 TCC3_CNT_A, TCC3_DFS_A, TCC3_ERR_A, TCC3_FAULT0_A, TCC3_FAULT1_A, TCC3_FAULTA_A, TCC3_FAULTB_A, TCC3_OVF, TCC3_TRG, TCC3_UFS_A */
        .pfnTCC3_MC0_Handler      = (void*) TCC3_1_Handler,         /* 102 TCC3_MC_0 */
        .pfnTCC3_MC1_Handler      = (void*) TCC3_2_Handler,         /* 103 TCC3_MC_1 */
#else
...
#endif
#ifdef ID_TCC4
        .pfnTCC4_OTHER_Handler      = (void*) TCC4_0_Handler,         /* 104 TCC4_CNT_A, TCC4_DFS_A, TCC4_ERR_A, TCC4_FAULT0_A, TCC4_FAULT1_A, TCC4_FAULTA_A, TCC4_FAULTB_A, TCC4_OVF, TCC4_TRG, TCC4_UFS_A */
        .pfnTCC4_MC0_Handler      = (void*) TCC4_1_Handler,         /* 105 TCC4_MC_0 */
        .pfnTCC4_MC1_Handler      = (void*) TCC4_2_Handler,         /* 106 TCC4_MC_1 */
#else
...
#endif
        .pfnPDEC_OTHER_Handler      = (void*) PDEC_0_Handler,         /* 115 PDEC_DIR_A, PDEC_ERR_A, PDEC_OVF, PDEC_VLC_A */
        .pfnPDEC_MC0_Handler      = (void*) PDEC_1_Handler,         /* 116 PDEC_MC_0 */
        .pfnPDEC_MC1_Handler      = (void*) PDEC_2_Handler,         /* 117 PDEC_MC_1 */
        .pfnADC0_OTHER_Handler      = (void*) ADC0_0_Handler,         /* 118 ADC0_OVERRUN, ADC0_WINMON */
        .pfnADC0_RESRDY_Handler      = (void*) ADC0_1_Handler,         /* 119 ADC0_RESRDY */
        .pfnADC1_OTHER_Handler      = (void*) ADC1_0_Handler,         /* 120 ADC1_OVERRUN, ADC1_WINMON */
        .pfnADC1_RESRDY_Handler      = (void*) ADC1_1_Handler,         /* 121 ADC1_RESRDY */
        .pfnAC_Handler          = (void*) AC_Handler,             /* 122 Analog Comparators */
        .pfnDAC_OTHER_Handler       = (void*) DAC_0_Handler,          /* 123 DAC_OVERRUN_A_0, DAC_OVERRUN_A_1, DAC_UNDERRUN_A_0, DAC_UNDERRUN_A_1 */
        .pfnDAC_EMPTY_0_Handler       = (void*) DAC_1_Handler,          /* 124 DAC_EMPTY_0 */
        .pfnDAC_EMPTY_1_Handler       = (void*) DAC_2_Handler,          /* 125 DAC_EMPTY_1 */
        .pfnDAC_RESRDY_0_Handler       = (void*) DAC_3_Handler,          /* 126 DAC_RESRDY_0 */
        .pfnDAC_RESRDY_1_Handler       = (void*) DAC_4_Handler,          /* 127 DAC_RESRDY_1 */
#ifdef ID_I2S
